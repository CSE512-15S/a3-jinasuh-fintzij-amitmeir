    ...
    */
    ...
    function drawSubunits(data) {
        var fillData = this.options.fills,
            fillFunc = this.options.fillFunc,
        ...
        geo.enter()
          ...
          .style('fill', function (d) {
              ...
              if (datum && fillFunc) {
                  fillColor = fillFunc(datum);
              }
              else if (datum && datum.fillKey) {
    ...
    function handleBubbles(layer, data, options) {
        ...
        //.transition().duration(400)
          .attr('r', function (datum) {
              if (options.radiusFunc) {
                  return options.radiusFunc(datum);
              }
              else {
        ...
        for (var subunit in data) {
            if (data.hasOwnProperty(subunit)) {
                ...
                if (!subunit) {
                    ...
                    // JINA HACK
                else if (this.options.fillFunc) {
                    color = this.options.fillFunc(subunitData);
                }
                else {
